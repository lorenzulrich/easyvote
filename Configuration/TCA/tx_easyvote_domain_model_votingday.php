...
$GLOBALS['TCA']['tx_easyvote_domain_model_votingday'] = [
    'ctrl' => [
    ...
    'types' => [
        '1' => ['showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, voting_date, archived, upload_allowed, meta_voting_proposals,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
    ],
    'columns' => [
        ...
        'meta_voting_proposals' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND tx_easyvote_domain_model_metavotingproposal.sys_language_uid IN (-1,0) ORDER BY private_title ASC',
