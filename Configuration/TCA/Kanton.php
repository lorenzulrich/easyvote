...
$TCA['tx_easyvote_domain_model_kanton'] = array(
	...
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, abbreviation, cities,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
			...
			'config' => array(
				...
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_easyvote_domain_model_city',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
